...
**Redeemable NFTs** is an Ethereum standard proposal suggested by Āto.

- Github repository: [https://github.com/ATO-nft/redeemable](https://github.com/ATO-nft/redeemable)
